...
public class MailService {
	...
	public void sendSimpleMail(int userId) {
		...
		msg.setFrom("bahaidong@163.com");
		msg.setTo("xingkong0325@126.com");
		msg.setReplyTo("bahaidong@163.com");
		msg.setCc("bahaidong@news.cn");
		msg.setSubject("注册成功");
	...
	public void sendHtmlMail(int userId) throws MessagingException {
		...
		helper.setFrom("bahaidong@163.com");
		helper.setTo("xingkong0325@126.com");
